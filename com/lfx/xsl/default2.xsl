...
<link rel="stylesheet" href="/dba/webchart.css" type="text/css" media="screen" />
<xsl:if test="param[@id='HTML.CSS']">
<link rel="stylesheet" type="text/css" media="screen">
<xsl:attribute name="href"><xsl:value-of select="param[@id='HTML.CSS']" disable-output-escaping="yes" /></xsl:attribute>
</link>
</xsl:if>
